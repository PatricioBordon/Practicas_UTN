/*UTNFRGP
Ejercicio:  Hacer un programa para ingresar por teclado el importe de una venta sin el descuento y el
...
int main(){
    int ventaSinDescuento, ventaConDescuento, porcentaje;

    cout<<"Ingresar el importe de la venta sin descuento: $";
    cin>>ventaSinDescuento;
    cout<<"Ingresar el importe de la venta con descuento: $";
    cin>>ventaConDescuento;

    porcentaje = 100 - ventaConDescuento * 100 / ventaSinDescuento;

    cout<<"Porcentaje de descuento: %"<<porcentaje<<"\n";
